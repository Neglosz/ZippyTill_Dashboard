...
const ResetPasswordPage = () => {
  ...
  const handleResetPassword = async (e) => {
    ...
    try {
      ...
      setError(err.message || "เกิดข้อผิดพลาดในการส่งอีเมล กรุณาลองใหม่");
    } finally {
      setLoading(false);
    }
  };
