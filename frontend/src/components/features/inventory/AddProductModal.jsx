              ...
              <div className="grid grid-cols-1 gap-3">
                ...
                <div className="space-y-1.5">
                  ...
                  <input
                    ...
                    className="w-full bg-[#F8FAFD] border-none rounded-[16px] px-4 py-3 text-sm font-bold text-[#1B2559] focus:outline-none focus:ring-2 focus:ring-primary/20 transition-all placeholder:text-gray-400 shadow-sm"
                ...
                <div className="space-y-1.5">
                  ...
                  <div className="relative">
                    <input
                      ...
                      value={formData.cost}
                      onChange={handleChange}
                      className="w-full bg-[#F8FAFD] border-none rounded-[16px] px-4 py-3 text-sm font-bold text-[#1B2559] focus:outline-none focus:ring-2 focus:ring-emerald-500/20 transition-all text-right pr-12 shadow-sm"
                      placeholder="0.00"
                    />
                ...
                <div className="space-y-1.5">
                  ...
                  <div className="relative">
                    <input
                      ...
                      onChange={handleChange}
                      className="w-full bg-emerald-50 text-emerald-600 border-none rounded-[16px] px-4 py-3 text-sm font-black focus:outline-none focus:ring-2 focus:ring-emerald-500/30 transition-all text-right pr-12 shadow-md shadow-emerald-200/5"
                      placeholder="0.00"
                    />
                ...
                <div className="space-y-1.5">
                  ...
                  <div className="relative">
                    <input
                      ...
                      onChange={handleChange}
                      className="w-full bg-orange-50/30 text-orange-600 border border-dashed border-orange-200/50 rounded-[16px] px-4 py-3 text-sm font-bold focus:outline-none focus:ring-2 focus:ring-orange-500/20 transition-all text-right pr-12 shadow-sm"
                      placeholder="0"
                    />
